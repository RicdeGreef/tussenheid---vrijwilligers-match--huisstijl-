...
export const Results: React.FC<ResultsProps> = ({ likedProjects, userName, onRestart }) => {
  return (
      ...
      <div className="bg-[#f1f3de] rounded-3xl p-8 shadow-2xl border-b-4 border-[#dadcd1]">
        <div className="text-center mb-8">
            ...
            {likedProjects.length === 0 
                ...
                : `Top keuze ${userName}! Dit zijn de organisaties waar je aan de slag gaat:`}
            </p>
        </div>
        ...
        <div className="space-y-6 max-h-[50vh] overflow-y-auto pr-2 custom-scrollbar">
          {likedProjects.map((proj, idx) => (
            <div 
              key={idx} 
              className="bg-white border border-[#dadcd1] rounded-2xl p-6 hover:shadow-md transition-all group"
            >
              <div className="flex justify-between items-start mb-3">
                {/* Organization is now the Main Title */}
                ...
                <ExternalLink size={18} className="text-[#dadcd1] cursor-pointer hover:text-[#1c3047]" />
              </div>
              ...
              {/* Revealed Project/Role Block - Blue theme based on brand Blue */}
